...
>
> The embedded demo block was removed during the 2026-05-26 rebalancing. The short deck (23 slides) now stands on its own conceptually. This plan is preserved as a guide for an optional supplementary video that can be shared as appendix material or used in specific deliveries, but it does not appear in the main session flow.
