...
Observability is a dedicated section of the deck, not a single bullet. The deck stands on its own as a 1-hour webinar. An optional backup video can be recorded for specific deliveries, but the slides do not depend on it.
...
The Agent Development Lifecycle section is consciously deferred to the 8-hour track.
...
| Agent Development Lifecycle | (none) | 0% - deferred to 8-hour track |
| Evaluation | 11, 12 | 12% |
