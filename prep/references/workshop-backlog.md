...
This backlog is a practical starting point for the next editing sessions.
...
- Add a visual concept for each slide.
- Build a demo video script with precise timing.
...
- Define a common scenario used across all labs.
- Create a lab template.
- Implement labs in order: foundations, evaluation, gates, observability, safety/governance, continuous improvement.
- Add a capstone readiness review worksheet.

## Observability backlog

- Define the canonical trace schema.
- Define correlation fields across Foundry, repo, CI/CD, telemetry, incident, and eval systems.
- Design dashboard views for executive readiness, operations, agent behavior, and continuous improvement.
- Create alert categories for tool failures, latency regression, cost spikes, safety events, missing telemetry, and eval failures.
- Create a trace-review worksheet.
- Add an example of converting a production trace into a future eval case.
